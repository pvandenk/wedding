...
const dinerInvitees = [
    ...
    { event: eventTypes.all, name: "Anniek Gryp", partner: "Andy Claeys", children: ["Zoë Claeys", "Uwe Claeys"] },
    ...
    { event: eventTypes.all, name: "Els Desmet", partner: "Vincent Lampole", children: ["Manou Devogelaere", "Leon Devogelaere"] },
